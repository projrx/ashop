...
<body>
	...
	$rows =mysqli_query($con,"SELECT * FROM jewelry where slug='$page' ORDER BY ordr " ) or die(mysqli_error($con));
	$n=0;
	...
	<div class="container">
		...
		<ul class="breadcrumb">
			...
			<li><a href="jewelry.php">Jewllery</a> <span class="divider">/</span></li>
		...
		<div class="well well-small">
			<div class="row">
				<div class="col-md-7">
					<div id="myCarousel" class="carousel slide cntr">
						<div class="carousel-inner">
							<video id="p-video" class="pvideo" width="100%" height="418" loop muted autoplay> <source src='<?php echo $vid ?>' type='video/mp4'> </video> 
							</div>
				...
				<div id="home" class="tab-content tabWrapper">
					...
					$rows =mysqli_query($con,"SELECT * FROM jewelry where pslug='$pslug'  ORDER BY RAND()  LIMIT 6" ) or die(mysqli_error($con));
					$n=0;
					...
					<div class="row">	  
							...
							<div class="col-md-4 alignR">
								<form class="form-horizontal qtyFrm">
									...
									<div class="btn-group">
										<form action="" method="get">
									<h4><button class="shopBtn atcf" name="addcart" value="<?php echo $slug ?>"> Add to cart </button></h4>
									<input style="display: none" name="type" value="jewelry" name="type"> 
																	
									<input style="display: none" name="page_name" value="<?php echo $page ?>"> 

										</form>
										<a href="djewelry.php?page_name=<?php echo $slug ?>" class="viewf shopBtn">VIEW</a>
									</div>
								</form>
							</div>
						</div>

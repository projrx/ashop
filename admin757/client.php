        ...
        <div class="col-lg-10">
          <div class="widget-container fluid-height clearfix">
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-group"></i> <?php echo $page ?> Clients
            </div>
                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td>
                        <img id="ccatimg" src="../images/clients/<?php echo $img ?>" class="form-control" ?>
                      </td>
                      <td>
    ...
    <div class="container-fluid main-content">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading">
              <i class="fa fa-tags"></i>Clients Category
            </div>
            <div class="widget-content padded clearfix">
              <table class="table table-bordered">
                <thead>
                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td>
                        <img id="catimg" src="../images/clients/<?php echo $img ?>" class="form-control" ?>
                      </td>
                      <td>

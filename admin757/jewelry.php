...
<head>
  ...
  <?php if(!empty( $_GET['project_name'])) $page = $_GET['project_name'] ?>
  ...
  for ($i=0; $i < 100 ; $i++) { 
    ...
    if(isset($_POST['savecat'.$i])){
      ...
      if (!empty($_FILES['img'.$i]['name'])) {
        ...
        $target = "../images/jewelrys/".basename($image);

        $data=mysqli_query($con,"UPDATE jewelrycat SET `img`='$image' where `id`='$id'")or die( mysqli_error($con) );
      ...
      */
      ...
      $sql = "UPDATE jewelrycat SET `name` = '$name',`slug` = '$slug',`ordr` = '$ordr' WHERE `id` =$id";

      mysqli_query($con, $sql) ;
      ($msg=mysqli_error($con));
      if(empty($msg))  $msg="Updated";
      header("location:jewelrys-$slug");
  ...
  for ($i=0; $i < 100 ; $i++) { 
    ...
    if(isset($_POST['delcat'.$i])){
      ...
      $sql = "DELETE FROM jewelrycat WHERE id=$id ";

      mysqli_query($con, $sql) ;

      $sql = "DELETE FROM  WHERE pid=$id  ";

      mysqli_query($con, $sql) ;
      ($msg=mysqli_error($con));

      if(empty($msg))  $msg="jewelry Category Deleted";
  ...
  $data=mysqli_query($con,"INSERT INTO jewelrycat (name,slug,ordr)VALUES ('$name','$slug','$ordr')")or die( mysqli_error($con) );
  ...
  for ($i=0; $i < 100 ; $i++) { 
    ...
    if(isset($_POST['saveccat'.$i])){
      ...
      $sql = "UPDATE jewelry SET `name` = '$name',`slug` = '$slug',`metak` = '$metak',`metad` = '$metad',`ordr` = '$ordr',`feat` = '$feat' WHERE `id` =$id";
  ...
  for ($i=0; $i < 100 ; $i++) { 
    ...
    if(isset($_POST['delccat'.$i])){
      ...
      $sql = "DELETE FROM jewelry WHERE id=$id  ";

      mysqli_query($con, $sql) ;
      ($msg=mysqli_error($con));

      if(empty($msg))  $msg="jewelry Deleted";
  ...
  if(isset($_POST['addccat'])){
      ...
      $msg="Unsuccessful" ;
       ...
       $rows =mysqli_query($con,"SELECT id FROM jewelrycat where slug='$page'  ORDER BY ordr" ) or die(mysqli_error($con));
  ...
  $data=mysqli_query($con,"INSERT INTO jewelry (name,pid,pslug,slug,metak,metad,ordr,feat)VALUES ('$name','$id','$page','$slug','$metak','$metad','$ordr','$feat')");

  ($msg=mysqli_error($con));

  if(empty($msg))  $msg="jewelry Added";

      header("location:djewelrys-$slug");
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-lightbulb-o"></i> <?php echo $page ?> jewelry
            </div>
            <div class="widget-content padded clearfix">
              ...
              <tbody>
                ...
                $rows =mysqli_query($con,"SELECT * FROM jewelry where pslug='$page'  ORDER BY ordr" ) or die(mysqli_error($con));
                $n=0;
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <a href="djewelrys-<?php echo $slug ?>" class="btn btn-primary-outline" value="<?php echo $id ?>"> </i> <i class="fa fa-pencil"></i></a>
    ...
    <div class="container-fluid main-content">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading">
              <i class="fa fa-tags"></i>jewelrys Category
            </div>
            <div class="widget-content padded clearfix">
              <table class="table table-bordered">
                <thead>
              ...
              <tbody>
                ...
                $rows =mysqli_query($con,"SELECT * FROM jewelrycat  ORDER BY ordr" ) or die(mysqli_error($con));
                $n=0;
                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <!--
                      <td>
                        <img id="catimg" src="../images/jewelrys/<?php echo $img ?>" class="form-control" ?>
                      </td>
                      <td>
                    ...
                    -->
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <a href="jewelrys-<?php echo $slug ?>" class="btn btn-primary-outline" value="<?php echo $id ?>"> </i> <i class="fa fa-plus"></i></a>
